...
def add_exception_handler(app: FastAPI):
    ...
    @app.exception_handler(MonteCarloResultException)
    async def monte_carlo_result_exception_handler(request: Request,
                                                   exc: MonteCarloResultException):
        return JSONResponse(
